...
def multi_owner_dandiset(server, admin, user):
    ...
    identifier = created_dandiset["meta"]["dandiset"]["identifier"]["value"]
...
def test_initial_dandiset_owners(server, admin, admin_created_dandiset):
    ...
    """
    identifier = admin_created_dandiset["meta"]["dandiset"]["identifier"]["value"]
...
def test_remove_dandiset_owners(server, admin, user, multi_owner_dandiset):
    ...
    identifier = multi_owner_dandiset["meta"]["dandiset"]["identifier"]["value"]
